...
@Service("SecondaryTableThreeServiceImpl")
public class SecondaryTableThreeServiceImpl implements TableThreeService{
	@Resource(name = "SecondaryTableThreeDaoImpl")
